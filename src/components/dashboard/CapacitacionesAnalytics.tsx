...
export default function CapacitacionesAnalytics({ filters }: { filters: any }) {
        ...
        <Card className="glass border-[var(--card-border)] bg-gradient-to-br from-purple-900/20 to-transparent">
          <CardContent className="p-4 flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold text-purple-400">{totalParticipantesCap.toLocaleString("es-PA")}</h3>
            </div>
        ...
        <Card className="glass border-[var(--card-border)] bg-gradient-to-br from-teal-900/20 to-transparent">
          <CardContent className="p-4 flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold text-teal-400">{totalHorasCap.toLocaleString("es-PA")}</h3>
            </div>
        ...
        <Card className="glass border-[var(--card-border)] bg-gradient-to-br from-orange-900/20 to-transparent">
          <CardContent className="p-4 flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold text-orange-400">{totalParticipantesAct.toLocaleString("es-PA")}</h3>
            </div>
