...
-- SECURITY INVOKER: la vista respeta RLS y permisos del usuario que consulta,
-- no del owner (fix para aviso crítico de Supabase: "SECURITY DEFINER view bypasses RLS")
DROP VIEW IF EXISTS public.ipa_infoplazas_activas;
CREATE VIEW public.ipa_infoplazas_activas
...
-- 9. Función RPC para Reportes Personalizados Ad-Hoc
